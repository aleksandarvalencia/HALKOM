...
<html>
	<head>
		...
		<meta name="viewport" content="width=device-width" />
                <link type="text/css" rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/jstree/3.0.9/themes/default/style.min.css" />
                <link type="text/css" rel="stylesheet" href="/include/hello.css"/>
                ...
                <link type="text/css" rel="stylesheet" media="screen" href="http://tarruda.github.com/bootstrap-datetimepicker/assets/css/bootstrap-datetimepicker.min.css">
                <script type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/1/jquery.min.js"></script>
		<script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/jstree/3.0.9/jstree.min.js"></script>
		...
		//#container { min-width:320px; margin:0px auto 0 auto; background:white; border-radius:0px; padding:0px; overflow:hidden; }
                #container {max-width:300px; margin:0px auto 0 auto; background:white;background-color: #006699; border-radius:0px; padding:0px; overflow:hidden; }
                ...
                #headcontainer { max-width:300px; margin:0px auto 0 auto; background:white;background-color: #006699; border-bottom:1px solid silver; border-radius:0px; padding:0px; overflow:hidden; }
		//#tree { float:left; min-width:250px; border-right:1px solid silver; overflow:auto; padding:0px 0; }
                #tree { float:left; max-width:300px;width:250px; border-right:1px solid silver; overflow:auto; padding:0px 0;background-color:#006699;color:mintcream;vertical-align:top;font-weight:normal;}
	...
	<body>
            ...
            <div id="headcontainer" style="vertical-align:top;background-color:mintcream;">
...
<table style="width:250px;text-align:center;background-color:#006699">
                    <tr>
                    ...
                    <tr>
                        <td style="width:125px;border-right:1px solid silver;text-align:center;">
                                <a id="open_image" href="#"><img border='0' src="/HALKOM/include/img/folder-open50.png" alt="Open" style="margin-left:auto;margin-right:auto;" onClick="OpenTree();"/></a>
                        </td>
                        <td style="width:125px;text-align:center;">
                                <a id="close_image" href="#"><img border='0' src="/HALKOM/include/img/folder-closed50.png" alt="Close" style="margin-left:auto;margin-right:auto;" onClick="CloseTree();"/></a>
                         </td>
                    </tr>
                </table>
            </div>
			...
			$('#tree')
				.jstree({
					...
					'plugins' : ['themes','hotkeys','json_data','types','contextmenu','ui','search','sort']
                                ...
                                {                  
                                           var pagelink="/HALKOM/" + data.node.data.text;
                                           //alert(pagelink);
